...
@TypeGraphQL.InputType("AgentStatusOrderByWithRelationInput", {
  isAbstract: true
})
export class AgentStatusOrderByWithRelationInput {
  ...
  agent?: AgentOrderByWithRelationInput | undefined;
